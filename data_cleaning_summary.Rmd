...
I think the New York state suffer the most damage due to flood during2020 to 2021,and I just seperate state by the amount of damage for 6 part to make it more visualization,to find more information about the damage,I just repeat the steps above to find about the damage for crops and property for each state.